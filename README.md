...
### The schema of this API is uploaded to this repo as 'API doc.pdf'. It's generated by drf-yasg, at ```localhost/api/docs```, to access this by running Django server on your machine, please do ```pip install --upgrade drf_yasg``` in cmd.
